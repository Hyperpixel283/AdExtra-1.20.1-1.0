...
public class AdExtraRocketModelTier5 extends VehicleModel<AdExtraRocketTier5> {
    public static final ModelLayerLocation TIER_5_LAYER = new ModelLayerLocation(new ResourceLocation("adextra", "tier_5_rocket"), "main");

    public AdExtraRocketModelTier5(ModelPart root) {
        super(root, "rocket");
    }
